		...
		<div>
			<div className="bg-[#1ea1f7] h-[97px]">
				<div className="w-full pt-2">
					<img src="https://s-lol-web.op.gg/images/icon/opgglogo.svg" className="w-20"/>
				</div>
				<div className="flex items-center justify-end bg-transparent relative pt-5 pr-20">
					...
					<div className="ml-5 flex flex-col justify-between h-[120px]">
						<div className="flex space-x-3 items-center">
							...
							<div className="border-2 rounded-md p-1 font-light flex justify-between items-center space-x-1">
								...
								<span className="text-[10px] text-gray-500">즐겨찾기</span>
							</div>
						</div>
